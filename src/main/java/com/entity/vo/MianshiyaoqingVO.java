...
public class MianshiyaoqingVO  implements Serializable {
	...
	public void setMianshineirong(String mianshineirong) {
		this.mianshineirong = mianshineirong;
	}
	
	/**
	 * 获取：面试内容
	 */
	public String getMianshineirong() {
		return mianshineirong;
	}
