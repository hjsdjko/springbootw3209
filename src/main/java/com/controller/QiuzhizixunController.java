...
public class QiuzhizixunController {
    ...
    public R page(@RequestParam Map<String, Object> params,QiuzhizixunEntity qiuzhizixun,
		...
		if(tableName.equals("qiye")) {
			qiuzhizixun.setQiyezhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("xuesheng")) {
			qiuzhizixun.setXueshengzhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R query(QiuzhizixunEntity qiuzhizixun){
		...
		return R.ok("查询求职咨询成功").put("data", qiuzhizixunView);
    }
